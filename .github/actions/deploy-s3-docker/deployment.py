...
def run():
    bucket = os.environ['INPUT_BUCKET'] # estas 3 env variables las genera automaticamente github a partir del nombre de los inputs en action.yml, le agrega INPUT_
